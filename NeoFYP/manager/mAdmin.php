...
?>
    ...
    <section class="home-section">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="mDash.php">Home</a>
              </li>
            </ul>
            <td width="15%">
      ...
      <p style="font-size: 30px;padding-left:12px;font-weight: 600;">Admin List</p>
           ...
           if ($num = mysqli_num_rows($run)>0) {  
                while ($result = mysqli_fetch_assoc($run)) {  
                     echo "  
                          <tr class='data'>  
                          <td>".$i++."</td>  
                               <td><b>".$result['aId']."</b></td>  
                               <td>".strtoupper($result['aName'])."</td>  
                               <td>".$result['aEmail']."</td>
                               <td>".$result['aTel']."</td>   
                               <td>".strtoupper($result['aAddress'])."</td>  
                               <td><button id=idbtn><a href='delete.php?id=".$result['aEmail']."' id='btn-delete' . 'class=btn'>Delete</a></button></td>  
                          </tr>  
                     ";  
                }  
           }  
