...
$list110 = $database->query("select * from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join customer on customer.cId=appointment.cId inner join admin on schedule.aId=admin.aId  where  admin.aId=$userid ");
      ...
      <tr>
                ...
                <?php
                    ...
                    $sqlmain= "select appointment.appID,schedule.scheduleid,schedule.title,admin.aName,customer.cName,schedule.scheduledate,schedule.scheduletime,appointment.appNum,appointment.appDate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join customer on customer.cId=appointment.cId inner join admin on schedule.aId=admin.aId  where  admin.aId=$userid ";
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
                                        ...
                                        <!--<a href="?action=view&id='.$appID.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">View</font></button></a>
                                       &nbsp;&nbsp;&nbsp;-->
                                       <a href="?action=drop&id='.$appID.'&name='.$cName.'&session='.$title.'&appNum='.$appNum.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-delete"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Cancel</font></button></a>
                                       &nbsp;&nbsp;&nbsp;</div>
                                        </td>
                                    </tr>';
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="aId" class="form-label">Select Doctor: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="aId" id="" class="box" >
                                    <option value="" disabled selected hidden>Choose Doctor Name from the list</option><br/>';
                                        
        
                                        $list11 = $database->query("select  * from  admin;");
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            ...
                            Appointment number &nbsp; : <b>'.substr($appNum,0,40).'</b><br><br>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="aDash.php"><input type="button" value="OK" class="login-btn btn-primary-soft btn" ></a>
