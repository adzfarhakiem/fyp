...
?>
    ...
    <nav class="navbar navbar-expand-lg" id="nav">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="aDash.php">Home</a>
              </li>
            </ul>
            <td width="15%">
      ...
      <p style="font-size: 30px;padding-left:12px;font-weight: 600;">Customer List</p>
           ...
           if ($num = mysqli_num_rows($run)>0) {  
                while ($result = mysqli_fetch_assoc($run)) {  
                     echo "  
                          ...
                          <td>".strtoupper($result['cName'])."</td>  
                          <td>".$result['cEmail']."</td>
                          <td>".$result['cTel']."</td>   
                          <td>".strtoupper($result['cAddress'])."</td>
                               <td><button id=idbtn><a href='delete.php?id=".$result['cEmail']."' id='btn-delete' . 'class=btn'>Delete</a></button></td>  
                          </tr>  
                     ";  
                }  
           }  
